...
export function NotFound() {
  return (
    <div className="container-page flex flex-col items-center py-16 sm:py-32 text-center">
      <div className="font-mono text-5xl sm:text-7xl font-bold text-ink/10">404</div>
